...
import { ContabilidadeFinishComponent } from './contabilidade-finish/contabilidade-finish.component';
...
@Component({
  selector: 'app-contabilidade-detalhe',
  templateUrl: './contabilidade-detalhe.component.html',
  styleUrls: ['./contabilidade-detalhe.component.css'],
  animations: [
    trigger(
      'enterAnimation', [
        transition(':enter', [
...
export class ContabilidadeDetalheComponent implements OnInit {
  ...
  detailSale(){
    const modalRef = this.modalCtrl.open(ContabilidadeFinishComponent, { size: 'md', backdrop: 'static' });
